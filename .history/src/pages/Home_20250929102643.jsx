...
const Home = () => {
 ...
 const handleEdit = (index) => {
  const trimmed = input.trim();
  if (!trimmed) return alert("Please enter a valid input");
  ...
  if (editIndex !== -1) {
    ...
    axios.put(`http://localhost:5000/lists/${id}`, { action: trimmed })
      .then((res) => {
        console.log("Updated:", res.data);

        // Update local state
        const updatedItems = [...items];
        updatedItems[editIndex] = res.data.data; // use updated object from backend
